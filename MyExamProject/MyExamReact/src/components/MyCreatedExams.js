                        ...
                        {qns
                            ...
                            .map((data, idx) => (
                                <TableRow key={idx}>
                                    ...
                                    <TableCell onClick={() => addQuestions(data.id)} align='center' key={data.id}><PlayArrowOutlinedIcon>Start Exam</PlayArrowOutlinedIcon></TableCell >
                                </TableRow >
